...
<html>
  ...
  <div class="container">
      ...
      <h1>Русские стихи</h1><br><br>
        ...
        <% int i = 0;
        while(rs.next()){ i++;%>
        <% if(rs.getString("language").equals("2")){%>
        <%= rs.getString("title")%><br><br>
        <%= rs.getString("main")%><br>
                <span class="badge badge-warning">Добавлено в: <%= rs.getTimestamp("timestamp") %></span>
